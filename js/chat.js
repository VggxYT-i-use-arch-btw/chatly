...
import { formatAudioTime, drawWaveform, togglePlay, extractPeaks } from './audio.js';
import { fetchWithCache } from './db.js';
import { formatFileSize } from './r2.js';
 ...
 */
export function createMessageEl(msg, myId, onMediaClick) {
...
export function createChatItemEl(conv, otherUser, lastMsg, myId, onClick) {
...
export function createAvatarEl(user, size = 40) {
